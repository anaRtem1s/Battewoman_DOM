const gg =  () => {
  ...
  } // Creation of a function resetting some parameters.
  ...
  { 
    if(hiddenChosenWordA.indexOf('_') === -1)  
      ...
      displayBox.classList.add('disappear-end'); // Making the display of game state disappear when game is over.
      
      containerPage.classList.add('disappear-end');
      
      const myImg = document.createElement('div'); // Creation of a display area for evolutive images.
      
      popUpDisplay.appendChild(myImg); // Adding the image(s) into the HTML.
      
      myImg.innerHTML = `<img src="../Battewoman_DOM/img/0.jpg" alt="dead">`;
      
      myImg.classList.add('killing-bat'); 
      
      displayBox.classList.add('disappear-end'); // Making the display of game state disappear when game is over.
      
      containerPage.classList.add('disappear-end'); // Making the display of game state disappear when game is over.
      ...
      myImg.innerHTML = `<img src="../Battewoman_DOM/img/6.jpg" alt="dead">`;
...
} // Initializing game into a variable - function.

gg(); // Launching the game.